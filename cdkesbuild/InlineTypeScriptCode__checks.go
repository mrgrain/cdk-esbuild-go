...
func validateNewInlineTypeScriptCodeParameters(code *string, props interface{}) error {
	if code == nil {
		return fmt.Errorf("parameter code is required, but nil was provided")
	}
	...
	case *TransformOptions:
		props := props.(*TransformOptions)
		if err := _jsii_.ValidateStruct(props, func() string { return "parameter props" }); err != nil {
			return err
		}
	case TransformOptions:
		props_ := props.(TransformOptions)
		props := &props_
		if err := _jsii_.ValidateStruct(props, func() string { return "parameter props" }); err != nil {
			return err
		}
	case *TransformerProps:
		props := props.(*TransformerProps)
		if err := _jsii_.ValidateStruct(props, func() string { return "parameter props" }); err != nil {
			return err
		}
	case TransformerProps:
		props_ := props.(TransformerProps)
		props := &props_
		if err := _jsii_.ValidateStruct(props, func() string { return "parameter props" }); err != nil {
			return err
		}
	default:
		if !_jsii_.IsAnonymousProxy(props) {
			return fmt.Errorf("parameter props must be one of the allowed types: *TransformOptions, *TransformerProps; received %#v (a %T)", props, props)
		}
	}
